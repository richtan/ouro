...
INSERT INTO historical_data (id, slurm_job_id, payload, status, x402_tx_hash, price_usdc, compute_duration_s, llm_cost_usd, submitted_at, completed_at)
VALUES
  (gen_random_uuid(), 1001, '{"script":"echo hello","nodes":1,"time_limit_min":1}', 'completed', '0xaaa1', 0.0250, 12.5, 0.0008, now() - interval '23 hours', now() - interval '22.5 hours'),
  (gen_random_uuid(), 1002, '{"script":"python3 sim.py","nodes":2,"time_limit_min":5}', 'completed', '0xaaa2', 0.0450, 45.2, 0.0008, now() - interval '20 hours', now() - interval '19 hours'),
  (gen_random_uuid(), 1003, '{"script":"./run_bench.sh","nodes":1,"time_limit_min":2}', 'completed', '0xaaa3', 0.0300, 28.1, 0.0008, now() - interval '15 hours', now() - interval '14.5 hours'),
  (gen_random_uuid(), 1004, '{"script":"mpirun -np 4 solver","nodes":4,"time_limit_min":10}', 'completed', '0xaaa4', 0.1200, 120.7, 0.0008, now() - interval '10 hours', now() - interval '8 hours'),
  (gen_random_uuid(), 1005, '{"script":"echo test","nodes":1,"time_limit_min":1}', 'completed', '0xaaa5', 0.0250, 8.3, 0.0008, now() - interval '5 hours', now() - interval '4.8 hours'),
  (gen_random_uuid(), 1006, '{"script":"python3 train.py","nodes":2,"time_limit_min":3}', 'completed', '0xaaa6', 0.0380, 55.9, 0.0008, now() - interval '3 hours', now() - interval '2.5 hours'),
  (gen_random_uuid(), 1007, '{"script":"bash job.sh","nodes":1,"time_limit_min":1}', 'completed', '0xaaa7', 0.0250, 15.2, 0.0008, now() - interval '1 hour', now() - interval '50 minutes');
