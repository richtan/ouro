...
Key protocols: [x402](https://www.x402.org/) (HTTP payments), [ERC-8021](https://eips.ethereum.org/EIPS/eip-8021) (builder attribution), [ERC-8004](https://eips.ethereum.org/EIPS/eip-8004) (agent identity)
